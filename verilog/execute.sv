            ...
            if(ex_fu_in.fu_vld_alu[i]) begin
                if (ex_fu_in.fu_dat_alu[i].cond_branch) begin
                    ...
                    case (ex_fu_in.fu_dat_alu[i].opa_select)
                        OPA_IS_RS1:  opa_mux_out[i] = 0;//ex_fu_in.fu_dat_alu[i].rs1_value;
                    ...
                    endcase
                    $display("OPA_SELECT: %2d", ex_fu_in.fu_dat_alu[i].opa_select);

                    // ALU opB mux
                    case (ex_fu_in.fu_dat_alu[i].opb_select)
                        OPB_IS_RS2:   opb_mux_out[i] = 0;//ex_fu_in.fu_dat_alu[i].rs2_value;
